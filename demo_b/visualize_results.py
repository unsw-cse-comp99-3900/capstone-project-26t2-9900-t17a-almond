...
def main() -> None:
    ...
    run_options = None
    if "graph_" in args.run_dir.name:
        graph_runs = sorted(
            candidate for candidate in Path("outputs").glob("run_*graph*")
