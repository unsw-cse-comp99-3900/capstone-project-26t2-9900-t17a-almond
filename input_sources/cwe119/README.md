...
```powershell
python robustness_experiments\code\code_perturbations.py --input input_sources\cwe119\non_vulnerable
```

Run all ten samples in one command:

```powershell
python robustness_experiments\code\code_perturbations.py --input input_sources\cwe119 --recursive
```
